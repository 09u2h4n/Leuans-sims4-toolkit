...
namespace ModernDesign.MVVM.View
{
    public partial class DLCSelectorWindow : Window
    {
        ...
        private const string IMG_BASE_URL = "https://zeroauno.blob.core.windows.net/leuan/TheSims4/imgs/";

        public DLCSelectorWindow()
        {
            InitializeComponent();
            ApplyLanguage();
            InitializeDLCList();
        ...
        private Border CreateDLCCard(DLCItem item, string accentColor, bool isBaseGame)
        {
            ...
            else
            {
                ...
                var img = new Image
                {
                    Source = new System.Windows.Media.Imaging.BitmapImage(new System.Uri(IMG_BASE_URL + item.Code + ".jpg")),
